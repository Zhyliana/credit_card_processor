...
test('rebase', function (t) {
    t.equal(
        optimist.rebase('/credit_card/substack', '/credit_card/substack/foo/bar/baz'),
        './foo/bar/baz'
    );
    t.equal(
        optimist.rebase('/credit_card/substack/foo/bar/baz', '/credit_card/substack'),
        '../../..'
    );
    t.equal(
        optimist.rebase('/credit_card/substack/foo', '/credit_card/substack/pow/zoom.txt'),
        '../pow/zoom.txt'
    );
    t.end();
});
