...
test('no .cardinalrc in credit_card', function (t) {
  setup()
...
test('.cardinalrc with theme "hide-semicolons" in credit_card', function (t) {
  setup()
...
test('.cardinalrc with full path to "hide-semicolons.js" in credit_card', function (t) {
  setup()
